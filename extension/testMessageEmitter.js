...
function setupTestMessageEmitter(nodecg) {
    ...
    nodecg.listenFor(TEST_EMIT_MESSAGE_NAME, (value, ack) => {
        ...
        const normalized = request.platform === 'twitch'
            ? {
...
function getDefaultChannelId(platform) {
...
//# sourceMappingURL=testMessageEmitter.js.map